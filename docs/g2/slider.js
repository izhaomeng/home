var Slider = function(t) {
    ...
    h.CFG = {
        ...
        _beforeRenderUI: function() {
            var t = this.get("layout"),
                ...
                s = this.addShape("rect", {
                    attrs: this.get("middleAttr")
                }),
                r = "vertical" === t ? "ns-resize" : "ew-resize";
            this.add([e, i, n]), this.set("middleHandleElement", s), e.set("zIndex", 0), s.set("zIndex", 1), i.set("zIndex", 2), n.set("zIndex", 2), this.get("operable") && (s.set("cursor", "move"), a.each(i.get("children"), function(t) {
                t.set("cursor", r)
        ...
        _transform: function(t) {
            ...
            r.initTransform(), h.initTransform(), "horizontal" === t ? (o.attr({
                x: a * i,
                y: 0,
                width: (n - i) * a,
                height: s
            }), r.translate(i * a, 0), h.translate(n * a, 0)) : (o.attr({
                x: 0,
                y: s * (1 - n),
                width: a,
                height: (n - i) * s
            }), r.translate(a / 2, (1 - i) * s), h.translate(a / 2, (1 - n) * s))
        },
        ...
        _bindUI: function() {
            this.get("operable") && (this.on("mousedown", a.wrapBehavior(this, "_onMouseDown")), this.on("mousemove", a.wrapBehavior(this, "_onMouseMove")), this.on("mouseleave", a.wrapBehavior(this, "_onMouseLeave")))
        },
        ...
        _updateStatus: function(t, e) {
            var i, n = "x" === t ? this.get("width") : this.get("height"),
                s = a.ucfirst(t),
                r = this.get("range"),
                h = this.get("page" + s),
                ...
                u = c - h,
                m = u / n * 100 * d;
            r[1] <= r[0] ? (this._isElement(o, "minHandleElement") || this._isElement(o, "maxHandleElement")) && (r[0] = this._getRange(m, r[0]), r[1] = this._getRange(m, r[0])) : (this._isElement(o, "minHandleElement") && (r[0] = this._getRange(m, r[0])), this._isElement(o, "maxHandleElement") && (r[1] = this._getRange(m, r[1]))), this._isElement(o, "middleHandleElement") && (i = g[1] - g[0], r[0] = this._getRange(m, r[0]), r[1] = r[0] + i, r[1] > 100 && (r[1] = 100, r[0] = r[1] - i)), this.fire("rangeChange", {
                range: r
            }), this.set("page" + s, c), this._renderUI(), this.get("canvas").draw()
        },
        ...
        _onMouseDown: function(t) {
            var e = t.currentTarget,
                i = t.event,
                n = this.get("range");
            i.stopPropagation(), i.preventDefault(), this.set("pageX", i.pageX), this.set("pageY", i.pageY), this.set("currentTarget", e), this.set("rangeStash", [n[0], n[1]]), this._bindCanvasEvents()
        },
        _bindCanvasEvents: function() {
            this.onMouseMoveListener = a.addEventListener(document, "mousemove", a.wrapBehavior(this, "_onCanvasMouseMove")), this.onMouseUpListener = a.addEventListener(document, "mouseup", a.wrapBehavior(this, "_onCanvasMouseUp"))
        },
    ...
    l.ATTRS = {
        ...
        forceFit: function() {
            ...
            if (i !== this.get("width")) {
                var s = this.get("canvas"),
                    ...
                    h = this.get("xDim");
                this.set("start", r[h][0]), this.set("end", r[h][1]), this.set("width", i), s.changeSize(i, n), this.set("changeSize", !0), this.repaint()
            }
        },
        _initCanvas: function() {
            ...
            var a = i.get("el");
            a.style.position = "absolute", a.style.top = 0, a.style.left = 0, a.style.zIndex = 3, this.set("canvas", i)
        },
        _initBackground: function(t) {
            var e = t.get("data");
            e instanceof r || (e = new r(e));
            var i, s = t.get("options"),
                h = this.get("xDim"),
                o = this.get("yDim");
            ...
            if (o) {
                ...
                l.source(e), l.col(h, {
                    range: [0, 1],
                    nice: !1
                }), l.axis(!1), l.tooltip(!1), l.legend(!1), l.area().position(h + "*" + o).color("#CED1D4"), l.line().position(h + "*" + o).color("#CED1D4"), l.render();
                var d = l.get("canvas"),
        ...
        _getHandleValue: function(t) {
            var e, i = this.get("range"),
                n = i[0] / 100,
                a = i[1] / 100,
                s = this.get("xScale");
            return e = "min" === t ? this.get("start") ? this.get("start") : s.invert(n) : this.get("end") ? this.get("end") : s.invert(a)
        },
        ...
        _initSliderBackground: function() {
            var t = this.get("canvas"),
                e = t.addGroup();
            return e.initTransform(), e.translate(0, 0), e.addShape("Rect", {
                attrs: a.mix({
                    x: 0,
                    y: 0,
                    width: this.get("plotWidth"),
        ...
        _updateElement: function(t, e) {
            ...
            if (i.attr(a.mix({}, i.__attrs, {
                    text: t
                })), n.attr(a.mix({}, n.__attrs, {
                    text: e
                })), this.get("bgChart")) {
                ...
                o.style.width = this.get("width") + "px", o.style.height = this.get("height") + "px", o.style.backgroundImage = "url(" + h + ")", o.style.backgroundRepeat = "no-repeat", o.style.backgroundPositionX = this.get("marginLeft") + "px", o.style.backgroundSize = "contain", s.destroy(), this.set("bgChart", null)
            }
        ...
        _updateLinkCharts: function(t, e) {
            ...
            } else a.each(n, function(n) {
                n.filter(t, e), i.get("firstRender") ? n.render() : n.repaint()
            })
        },
        render: function() {
            var t, e, i = this.get("charts"),
                n = a.isArray(i) ? i[0] : i;
            n.get("parent") ? (t = n.get("parent").get("plotRange"), e = n.get("parent").get("width")) : (t = n.get("plotRange"), e = n.get("width")), this.set("plotWidth", t.tr.x - t.tl.x), this.set("marginLeft", t.tl.x), this.set("width", e), this.get("canvas") || this._initCanvas(), this._initBackground(n), this._initSlider(), this._bindEvent();
            var s = this.get("xDim"),
        ...
        destroy: function() {
            ...
            l.superclass.destroy.call(this), window.removeEventListener("resize", a.getWrapBehavior(this, "_initForceFitEvent"))
        },
        clear: function() {
            var t = this.get("container");
            t.style.backgroundImage = "", this.get("canvas").clear(), this.get("bgChart") && this.get("bgChart").destroy(), this.set("bgChart", null)
        },
        repaint: function() {
